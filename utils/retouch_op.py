...
# -------------------------------------调整画面黑白色阶分布的op  beta代表op作用的力度-------------------------------
def light(image,beta=0.2):
